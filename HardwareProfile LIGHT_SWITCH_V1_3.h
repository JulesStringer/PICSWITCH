...
// SW1 is connected to PIN 21
#define SW1_ANSEL                    (ANSELBbits.ANSB0)
#define SW1_CHS                      0
#define SW1_TRIS                     (TRISBbits.TRISB0)
#define SW1_LAT                      (LATBbits.LATB0)
#define SW1_PORT                     (PORTBbits.RB0)
#define SW1_WPUB                     (WPUBbits.WPUB0)
// SW2 is connected to PIN 22
...
#define SW3_WPUB                     (WPUBbits.WPUB2)

// SW4 is connected to PIN 26
#define SW4_ANSEL                    (ANSELBbits.ANSB5)
#define SW4_TRIS                     (TRISBbits.TRISB5)
#define SW4_LAT                      (LATBbits.LATB5)
#define SW4_PORT                     (PORTBbits.RB5)
#define SW4_WPUB                     (WPUBbits.WPUB5)
...
#define LED3_TSEL                     (CCPTMRS0bits.C2TSEL)
#define LED3_PWM_TRIS                 (LED3_TRIS)
#define LED3_CCPM                     (CCP2CONbits.CCP2M)
#define LED3_DCB                      (CCP2CONbits.DC2B)
#define LED3_CPPRL                    (CCPR2L)
...
#define LED1_ANSEL                    (ANSELBbits.ANSB4)
