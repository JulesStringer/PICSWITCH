...
// LED2 is connected to PIN 6
#define LED2_ANSEL                    (PRODL)
#define LED2_TRIS                     (TRISAbits.TRISA4)
#define LED2_LAT                      (LATAbits.LATA4)
#define LED2_PORT                     (PORTAbits.RA4)
	// CCP5 is on pin 6
#define LED2_TSEL                     (CCPTMRS1bits.C5TSEL)
#define LED2_PWM_TRIS                 (LED2_TRIS)
#define LED2_CCPM                     (CCP5CONbits.CCP5M)
#define LED2_DCB                      (CCP5CONbits.DC5B)
#define LED2_CPPRL                    (CCPR5L)
...
#define LED_COUNT 8
#elif SWITCH_ID >= 161 && SWITCH_ID <= 186
#define LED_COUNT 8
#else
#define LED_COUNT 4
#endif
...
#define LED5_ANSEL                    (ANSELBbits.ANSB5)
#define LED5_TRIS                     (TRISBbits.TRISB5)
#define LED5_LAT                      (LATBbits.LATB5)
#define LED5_PORT                     (PORTBbits.RB5)

#define LED6_ANSEL                    (ANSELBbits.ANSB5)
#define LED6_TRIS                     (TRISBbits.TRISB5)
#define LED6_LAT                      (LATBbits.LATB5)
#define LED6_PORT                     (PORTBbits.RB5)

#define LED7_ANSEL                    (ANSELBbits.ANSB5)
#define LED7_TRIS                     (TRISBbits.TRISB5)
#define LED7_LAT                      (LATBbits.LATB5)
#define LED7_PORT                     (PORTBbits.RB5)

#define LED8_ANSEL                    (ANSELBbits.ANSB5)
#define LED8_TRIS                     (TRISBbits.TRISB5)
#define LED8_LAT                      (LATBbits.LATB5)
#define LED8_PORT                     (PORTBbits.RB5)
#endif



#if (LED1_USE_PWM == 1 && LED2_USE_PWM == 1 && LED3_USE_PWM == 1 && LED4_USE_PWM == 1 && LED_COUNT <= 4)
...
#elif LED2_USE_PWM == 0
#define MIN_MANUAL_PWM 1
#elif LED3_USE_PWM == 0
#define MIN_MANUAL_PWM 2
#elif LED4_USE_PWM == 0
#define MIN_MANUAL_PWM 3
#elif LED_COUNT > 4
#if LED5_USE_PWM == 0
#define MIN_MANUAL_PWM 4
#else
