...
#define DI_ANSEL                   (ANSELAbits.ANSA3)
#define DI_TRIS                    (TRISAbits.TRISA3)                  
#define DI_IO                      (LATAbits.LATA3)
#define DI_PORT                    (PORTAbits.RA3)
...
// ADC2 pin 3
#define ADC2_ANSEL                    (ANSELAbits.ANSA1)
#define ADC2_CHS                      1
#define ADC2_TRIS                     (TRISAbits.TRISA1)

// ADC3 pin 4
#define ADC3_ANSEL                    (ANSELAbits.ANSA2)
#define ADC3_CHS                      2
#define ADC3_TRIS                     (TRISAbits.TRISA2)
...
#define LED1_ANSEL                    (PRODL)
#define LED1_PWM_TRIS                 (TRISAbits.TRISA5)
...
#define LED1_USE_PWM 0
#define LED1_ANSEL                    (PRODL)
#define LED1_PWM_TRIS                 (TRISAbits.TRISA7)
#define LED1_TRIS LED1_PWM_TRIS
...
#define LED2_PWM_TRIS                 (TRISAbits.TRISA6)
...
#define LED3_PWM_TRIS                 (TRISCbits.TRISC0)
...
#define LED5_PORT                     (PORTBbits.RB5)
	// P1D should have used 26 which is CCP3
#define LED5_TSEL                     (CCPTMRS0bits.C3TSEL)
#define LED5_PWM_TRIS                 (LED5_TRIS)
#define LED5_CCPM                     (CCP3CONbits.CCP3M)
#define LED5_DCB                      (CCP3CONbits.DC3B)
#define LED5_CPPRL                    (CCPR3L)
#define LED5_PWMMODE                  (CCP3CONbits.P3M)
